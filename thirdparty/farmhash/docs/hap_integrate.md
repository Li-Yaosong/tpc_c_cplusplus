...
&nbsp;![thirdparty_install_dir](pic/farmhash_test1.png)
...
-  进入到构建目录获取，事先准备一个svg测试文件用于转换为png。执行命令./svg2png test.svg，运行测试用例（farmhash/arm64-v8a-build为构建64位的目录，farmhash/armeabi-v7a-build为构建32位的目录）

&nbsp;![farmhash_test](pic/farmhash_test2.png)
