...
#ifndef IMAGE_KNIFE_C_ARKUI_BASE_NODE_H
#define IMAGE_KNIFE_C_ARKUI_BASE_NODE_H
...
public:
    ...
    void Reuse(int version)
    {
        this->componentVersion_ = version;
        this->nodeState_ = Available;
    }

    void Clear()
    {
        this->nodeState_ = Cleared;
        ClearDisplayedImage();
    }
    ...
    virtual void Display(void *data) = 0;
    virtual void FitImage(int fitEnum) = 0;
    virtual void ClearDisplayedImage() = 0;
...
#endif // IMAGE_KNIFE_C_ARKUI_BASE_NODE_H
