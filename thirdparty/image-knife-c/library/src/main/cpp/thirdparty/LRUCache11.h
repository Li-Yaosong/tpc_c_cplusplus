...
#ifndef IMAGE_KNIFE_C_LRUCACHE11_H
#define IMAGE_KNIFE_C_LRUCACHE11_H
#include <algorithm>
#include <cstdint>
#include <list>
#include <mutex>
...
public:
   ...
   */
    ...
    */
    ...
    // New method to get the tail element
    bool getTail(Key& key, Value& value)
    {
        Guard g(lock_);
        if (keys_.empty()) {
            return false;
...
#endif // IMAGE_KNIFE_C_LRUCACHE11_H
