...
- 在最外层（cpp目录下）CMakeLists.txt中添加如下语句
  ```
  #将三方静态库加入工程中
  target_link_libraries(entry PRIVATE ${CMAKE_CURRENT_SOURCE_DIR}/../../../libs/${OHOS_ARCH}/liblzo2.a)
  
  #将三方库的头文件加入工程中
  target_include_directories(entry PRIVATE ${CMAKE_CURRENT_SOURCE_DIR}/thirdparty/lzo/${OHOS_ARCH}/include)
  ```

&nbsp;![lzo_usage](pic/lzo_usage.PNG)
...
- 将准备好的文件推送到开发板，进入到构建的目录(thirdparty/lzo/lzo-armeabi-v7a-buil/examples)执行测试用例./simple
