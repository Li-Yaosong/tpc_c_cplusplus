...
- 下载本仓库
  ```
  git clone https://github.com/opendesigndev/liboctopus.git --depth=1
  ```
...
- 三方库头文件及生成的库
  ...
  ```
  liboctopus/arm64-v8a   liboctopus/armeabi-v7a   liboctopus/x86_64
  ```
...
- 在cpp目录下CMakeLists.txt中添加如下语句
  ...
  set(LIBOCTOPUS_LIB_PATH ${NATIVERENDER_ROOT_PATH}/${OHOS_ARCH}/lib/liboctopus.a)
