...
- 将c-ares拷贝至tools/main目录下

  ```
  cd tpc_c_cplusplus
  cp thirdparty/c-ares tools/main -rf
  ```
...
- 在最外层（cpp目录下）CMakeLists.txt中添加如下语句：
  ...
  target_link_libraries(entry PRIVATE ${CMAKE_CURRENT_SOURCE_DIR}/thirdparty/c-ares/${OHOS_ARCH}/lib/libcares.so.2)
  ...
  ```
  ![c-ares_usage](pic/c-ares_usage.png)
