...
- 三方库目录结构
  ...
  ```shell
  tpc_c_cplusplus/thirdparty/avro_release_1_11_3       #三方库avro_release_1_11_3的目录结构如下
  ├── docs                              #三方库相关文档的文件夹
  ├── HPKBUILD                          #构建脚本
  ├── SHA512SUM                         #三方库校验文件
...
- 三方库头文件及生成的库
  ...
  ```shell
  avro_release_1_11_3/arm64-v8a   avro_release_1_11_3/armeabi-v7a
  ```
- [测试三方库](#测试三方库)
