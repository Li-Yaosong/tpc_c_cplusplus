...
- 在最外层（cpp目录下）CMakeLists.txt中添加如下语句
  ```makefile
  #将三方库加入工程中
  target_link_libraries(entry PRIVATE ${CMAKE_CURRENT_SOURCE_DIR}/thirdparty/libwbxml/${OHOS_ARCH}/lib/libwbxml2.so)
...
```shell
cd tpc_c_cplusplus/thirdparty/AES/AES-44407f634f11992404596129ec31545e3f268ad3/arm64-v8a-build/test/tools
ctest
```
