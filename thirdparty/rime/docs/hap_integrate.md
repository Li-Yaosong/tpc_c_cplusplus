...
- 在最外层（cpp目录下）CMakeLists.txt中添加如下语句
  ...
  set(GTEST_ROOT "${CMAKE_CURRENT_SOURCE_DIR}/thirdparty/googletest/${OHOS_ARCH}")
  ...
  set(GFLAGS_ROOT "${CMAKE_CURRENT_SOURCE_DIR}/thirdparty/gflags/${OHOS_ARCH}")
  set(RIME_ROOT "${CMAKE_CURRENT_SOURCE_DIR}/thirdparty/rime/${OHOS_ARCH}")
  set(SNAPPY_ROOT "${CMAKE_CURRENT_SOURCE_DIR}/thirdparty/snappy/${OHOS_ARCH}")
  set(ZLIB_ROOT "${CMAKE_CURRENT_SOURCE_DIR}/thirdparty/zlib_1_3_1/${OHOS_ARCH}")
  ...
  target_link_libraries(entry PUBLIC
      ...
      ${GFLAGS_ROOT}/lib/libgflags.a
      ${SNAPPY_ROOT}/lib/libsnappy.a
      ${ZLIB_ROOT}/lib/libz.so.1
...
```shell
export LD_LIBRARY_PATH=/data/tpc_c_cplusplus/lycium/usr/:$LD_LIBRARY_PATH   #设置运行时链接动态库的地址
ctest                                                                       #执行测试用例
```
