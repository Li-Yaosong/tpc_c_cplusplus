...
- 三方库目录结构
  ...
  ```shell
  tpc_c_cplusplus/thirdparty/libjpeg-turbo_3_0_3    # 三方库libjpeg-turbo_3_0_3的目录结构如下
  ├── docs                                    # 三方库相关文档的文件夹
  ├── HPKBUILD                                # 编译脚本
  ├── HPKCHECK                                # 测试脚本
  ├── OAT.xml                                 # OAT开源审查文本
...
- 三方库头文件及生成的库
  ...
  ```shell
  libjpeg-turbo_3_0_3/arm64-v8a   libjpeg-turbo_3_0_3/armeabi-v7a
  ```
