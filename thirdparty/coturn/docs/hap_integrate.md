...
- 将coturn拷贝至lycium/main目录下
  ```
  cd tpc_c_cplusplus
  mkdir -p lycium/main
  cp thirdparty/openssl lycium/main -rf
  cp thirdparty/libevent lycium/main -rf
  cp thirdparty/sqlite lycium/main -rf
  cp thirdparty/coturn lycium/main -rf
  ```
- 在lycium目录下编译三方库
