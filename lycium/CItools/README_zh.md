...
| 工具名称  | 32位编译指导文档路径                                         | 64位编译指导文档路径                                         | X86编译指导路径                                              |
| :-------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
...
| shell_cmd | [shell_cmd_armeabi_v7a](./shell_cmd/shell_cmd_armeabi_v7a_Compilation_instructions.md) | [shell_cmd_arm64_v8a](./shell_cmd/shell_cmd_arm64_v8a_Compilation_instructions.md) | [shell_cmd](./shell_cmd/shell_cmd_x86_64_compilation_instructions.md) |
